...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="text" name="title" value="<?= get_about_us_article_info_by_id($id, 'title') ?>"
               class="form-control" id="title" placeholder="Article title here">
    </div>
</div>
    ...
    <div class="col-sm-6">
        ...
        <select required="" name="category" id="category" style="width:100%" class="populate">
            <optgroup label="Available categories">
                <option selected value="<?= get_about_us_article_info_by_id($id, 'category_id') ?>"
                        class="text-info"><?= get_about_us_article_info_by_id($id, 'category') ?></option>

                <?php
                $categories = get_about_us_categories();
    ...
    <div class="col-sm-6">
        ...
        <select required="" name="showcase" id="showcase" style="width:100%" class="populate">
            ...
            <option class="text-info" selected
                    value="<?= get_about_us_article_info_by_id($id, 'showcase') ?>"><?= get_about_us_article_info_by_id($id, 'showcase') == 'y' ? 'Yes' : 'No' ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <textarea name="content" id="editor0" class="form-control ckeditor message1">
            <?= get_about_us_article_info_by_id($id, 'content') ?>
        </textarea>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#edit').click(function () {
            ...
            var excerpt = jQuery("textarea.message2").val();
            var id = '<?=$id?>';
