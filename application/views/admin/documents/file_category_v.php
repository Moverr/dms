                        ...
                        if ($row['lock'] != 'y') {
                            ...
                            if (check_my_access('delete_file_categories')) {
                                ...
                                <a class="action_btn" href="" data-id="<?= $row['id'] ?>"
                                   data-action="delete_file_category" data-title="Delete  <?= ucwords($row['title']) ?>"
                                   data-toggle="modal" data-target="#myModal"><i class="fa fa-trash-o text-danger"></i></a>
                            <?php
                            }
