...
class Users_m extends CI_Model {
	...
	function validate_login_user($query_data, $ignore_active='')
	{
		...
		else
		{
			...
			$query = $this->Query_reader->get_query_by_code('user__login', $query_data);
		}
    ...
    {
      $sesionndata = $this->session->all_userdata();
      $sesndataa = $this->session->all_userdata();


        #Admin
        //$sesionndata->session->userdata('usertype') &&
        if ($sesndataa['alluserdata']['isadmin'] == 'Y') {
