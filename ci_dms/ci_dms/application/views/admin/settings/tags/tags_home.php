...
<div class="panel-heading ui-draggable-handle">
    <h3 class="panel-title">Listing <span class="badge badge-info"><?= count(get_all_tags()) ?></span></h3>
</div>
        ...
        <table class="table datatable">
            ...
            foreach ($all_tags as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <a class="action_btn" href="" data-id="<?= $row['id'] ?>" data-action="delete_tag"
                           data-title="Delete  <?= ucwords($row['title']) ?>" data-toggle="modal"
                           data-target="#myModal"><i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
            <?php
            }
