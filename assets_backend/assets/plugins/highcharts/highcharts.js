/**
 * Created by cengkuru on 4/6/2015.
 */
/*
...
(function () {
    ...
    Oa = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Aa(b - Wa(b)), e, f = d[sb](), g = d[tb](), h = d[Xa](), i = d[Ya](), j = d[Za](), k = S.lang, l = k.weekdays, d = q({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Ia(h),
            e: h,
    ...
    ta.prototype = {
        Element: L, init: function (a, b, c, d, e) {
                    ...
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            if (l) {
                                ...
                                (T ? -1 : 1) * sa(y)), o = [z + "â€¦"], x.removeChild(x.firstChild))) : !T || o.length === 1 ? (o = v, v = [], o.length && (w++, x = D.createElementNS(Ca, "tspan"), I(x, {
                                    dy: t,
                                    x: j
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, n, o, s, x, p, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        m(j.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || Z(Ka, {className: I(a.element, "class")}, {
                                position: "absolute",
    ...
    Ta.prototype = {
        addLabel: function () {
            ...
            var i = this.axis, j = i.transA, k = i.reversed,
                l = i.staggerLines, n = i.tickRotCorr || {
                        x: 0,
                        y: 0
            ...
            if (n && B)r === "inside" && (B = -B), d.opposite && (B = -B), h = this.getMarkPath(y, q, B, n * z, g, f), o ? o.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: u, "stroke-width": n, opacity: c}).add(d.axisGroup);
    ...
    va.prototype = {
        ...
        getOffset: function () {
            ...
            if (s && s.text && s.enabled !== !1) {
                if (!a.axisTitle)a.axisTitle = c.text(s.text, 0, 0, s.useHTML).attr({
                    ...
                    align: s.textAlign || {low: "left", middle: "center", high: "right"}[s.align]
                }).addClass("highcharts-" +
        ...
        render: function () {
            ...
            if (s)x =
                a.getLinePath(s), a.axisLine ? a.axisLine.animate({d: x}) : a.axisLine = c.path(x).attr({
                stroke: d.lineColor,
                "stroke-width": s,
                zIndex: 7
    ...
    va.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week",
                [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = F[d[0]], f = d[1], g;
    ...
    Va.prototype = {
        init: function (a, b) {
            ...
            (f = d.getAnchor([{}], a), d.updatePosition({plotX: f[0], plotY: f[1]}));
    ...
    q(A.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!d)b.loadingDiv = d = Z(Ka, {className: "highcharts-loading"}, q(e.style, {
                zIndex: 10,
                display: M
    ...
    if (N.pie)N.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0), n = e.distance, o =
            a.center, q = o[2] / 2, r = o[1], v = n > 0, y, u, z, D = [[], []], C, A, F, J, E, G = [0, 0, 0, 0], N = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            if (Fa(G) === 0 || this.verifyDataLabelOverflow(G))this.placeDataLabels(), v && g && m(this.points, function (b) {
                ...
                if ((y = b.dataLabel) && y._pos)F =
                    y._attr.visibility, C = y.connX, A = y.connY, k = l ? ["M", C + (z[6] === "left" ? 5 : -5), A, "C", C, A, 2 * z[2] - z[4], 2 * z[3] - z[5], z[2], z[3], "L", z[4], z[5]] : ["M", C + (z[6] === "left" ? 5 : -5), A, "L", z[2], z[3], "L", z[4], z[5]], j ? (j.animate({d: k}), j.attr("visibility", F)) : b.connector = j = a.chart.renderer.path(k).attr({
                    "stroke-width": g,
